...
export class LoopAlreadyRunningError extends ForgiumError { constructor() { super("Another Forgium run loop already owns the repository lease.", "LOOP_ALREADY_RUNNING", 3); } }
export class ClassificationInvalidError extends ForgiumError { constructor(message: string) { super(message, "CLASSIFICATION_INVALID", 2); } }
